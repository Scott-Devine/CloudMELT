...
rm GRCh38* commas_to_newlines.sh mosdepth2cov.py MELTv2.1.5.tar.gz bowtie2-2.3.4.3-linux-x86_64.zip cwltool_then_clean_tmp get_bam_and_bai.pl MELT-r38-v4-jc.jar 
